 ...
 * @author kunwa
 */
public class DeleteEmployeeFream extends javax.swing.JFrame {

    /**
     * Creates new form DeleteEmployeeFream
     */
    public DeleteEmployeeFream() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Empolyee");
...
try{
       ...
       if(a==0){
           boolean success=EmpDao.deleteEmployee(Integer.parseInt(txtId.getText()));
           if(success){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteEmployeeFream.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteEmployeeFream().setVisible(true);
            }
        });
    }
